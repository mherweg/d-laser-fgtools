...
# Bodensee
#SPAT="--spat 8.575 47.425 9.825 47.85"
# Karibik
#SPAT="--spat -64 17 -62 19"
# Helgoland
#SPAT="--spat 7.75 54 8 54.25"
# Frankfurt
#SPAT="--spat 8.375 49.875 8.625 50.125"
#SPAT="--spat 8 49 9 51"
# Indien
#SPAT="--spat 74.5 21.5 76.5 23.5"
# London
#SPAT="--spat -1 51 1 52"
# Madrid
#SPAT="--spat -5 40 -3 42"
# Oakland
#SPAT="--spat -123 37 -122 38"
# Baltimore
#SPAT="--spat -78 38 -76 40"
# Leipzig
#SPAT="--spat 12 51 13 52"
# Courchevel
#SPAT="--spat 6 45 7 46"
# Sylt
#SPAT="--spat 8 54 9 56"
# Hawaii
#SPAT="--spat -160 18 -154 23"
# Bad Hersfeld
#SPAT="--spat 9 50 10 51"
# Diego Garcia
#SPAT="--spat 72 -8 73 -7"
# Netherlands / FSweekend
#SPAT="--spat 2.8 49.8 8.2 54.2"
# Kopenhagen
#SPAT="--spat 12 55 13 56"
# Rheinland
#SPAT="--spat 6.5 50.5 7.5 51.5"
# EPBY
#SPAT="--spat 17.5 52.5 18.5 53.5"
# KEDW
#SPAT="--spat -120.5 32.5 -115.5 37.5"
# Berlin / LinuxTag
#SPAT="--spat 12.5 51.5 14.5 53.5"
# KOSH
#SPAT="--spat -91 42 -86 46"
# Grand Canyon
#SPAT="--spat -116 35 -109 38"
# WSAC
#SPAT="--spat 101 0 106 3"
# T3r
#SPAT="--spat 0 50 20 60"
# CLC2000
#SPAT="--spat -25.25 27.25 45 71.5"
# France (including Corsica)
#SPAT="--spat -5.20 41.31 8.4 51.12"
# Mathias SPT
#SPAT="--spat 10 47 12 49"
# Debug tile 1789153
#SPAT="--spat -71 -39 -70 -38"
# Debug tile 3138113
#SPAT="--spat 10 46 13 48"

#ZBAA
SPAT="--spat 116.5 40.02 116.7 40.15"

DATASOURCE="PG:dbname=${PGDATABASE} host=${PGHOST} user=webuser"

HOMEM=/home/martin
#OGRDECODE="${HOMEM}/terragear/bin/ogr-decode --all-threads --continue-on-errors --max-segment 400 ${SPAT}"
OGRDECODE="${HOMEM}/terragear/bin/ogr-decode --max-segment 400 ${SPAT}"
SHAPEDECODE="${HOMEM}/terragear/bin/shape-decode --max-segment 400"
COMMAND=${OGRDECODE}
